...
# Gulf Stream
# name_experiment = 'VarDyn-QG_eNATL60-BLBT02_GulfStream_1y_barotrop'


# Azores
name_experiment = 'VarDyn-QG_eNATL60-BLBT02_GulfStream_1y_20_04'
...
EXP = dict(
    ...
    path_save = f'{myPath}/outputs/BLBT02/avec_barotrope/{name_experiment}', # path of output files
...
#################################################################################################################################
NAME_BASIS =  ['myBASIS1', 'myBASIS2'] # NORA
...
myINV = dict(
    ...
    path_save_control_vectors = f'{myPath}/controls/BLBT02/avec_barotrope/{name_experiment}',
...
myDIAG = dict(
    ...
    dir_output = f'{myPath}/diags/BLBT02/avec_barotrope/{name_experiment}',
    ...
    name_exp_var = 'SSH_tot', # NORA

    path_images2mp4 = '/data1/packages/climporn/ffmpeg/images2mp4.sh',

    compare_to_baseline = False,

    name_bas = f'{myPath}/outputs/VarDyn-QG_eNATL60-BLBT02_GulfStream_float32/*.nc',
