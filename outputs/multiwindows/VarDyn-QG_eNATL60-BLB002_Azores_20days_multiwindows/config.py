...
name_experiment = 'VarDyn-QG_eNATL60-BLB002_Azores_20days_multiwindows'
...
EXP = dict(
    ...
    final_date = datetime(2009,9,30,0),  # final date (yyyy,mm,dd,hh) 
...
myDIAG = dict(
    ...
    name_bas = f'{myPath}/outputs/VarDyn-QG_eNATL60-BLB002_Azores_float32/*.nc',
