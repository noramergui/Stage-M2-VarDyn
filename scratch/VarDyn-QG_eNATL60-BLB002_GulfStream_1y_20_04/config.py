...
name_experiment = 'VarDyn-QG_eNATL60-BLB002_GulfStream_1y_20_04'
...
EXP = dict(
    ...
    path_save = f'{myPath}/outputs/BLB002/avec_barotrope/{name_experiment}', # path of output files
...
myDIAG = dict(
    ...
    name_exp_var = 'SSH_tot', # NORAsuper: INV_4DVAR
