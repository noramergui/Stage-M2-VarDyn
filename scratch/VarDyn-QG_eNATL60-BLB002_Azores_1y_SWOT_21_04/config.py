...
name_experiment = 'VarDyn-QG_eNATL60-BLB002_Azores_1y_SWOT_21_04'
...
EXP = dict(
    ...
    path_save = f'{myPath}/outputs/BLB002/SWOT/{name_experiment}', # path of output files
    ...
    final_date = datetime(2010,6,20,0),  # final date (yyyy,mm,dd,hh) 
...
myINV = dict(
    ...
    path_save_control_vectors = f'{myPath}/controls/BLB002/SWOT/{name_experiment}',
...
myDIAG = dict(
    ...
    dir_output = f'{myPath}/diags/BLB002/SWOT/{name_experiment}',
