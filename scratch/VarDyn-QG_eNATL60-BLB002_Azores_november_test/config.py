...
name_experiment = 'VarDyn-QG_eNATL60-BLB002_Azores_november_test'
...
EXP = dict(
    ...
    init_date = datetime(2009,11,1,0), # initial date (yyyy,mm,dd,hh) 

    final_date = datetime(2009,12,1,0),  # final date (yyyy,mm,dd,hh)  
...
myINV = dict(
    ...
    path_save_control_vectors = f'{myPath}/controls/BLB002/avec_barotrope/{name_experiment}',
...
myDIAG = dict(
    ...
    dir_output = f'{myPath}/diags/BLB002/Avec_barotrope/{name_experiment}',

    name_ref = f'{path_data}/degraded_20/*SSH*.nc',
